        ...
        do {
            ...
            switch (luaChon) {
                ...
                case 4:
                    ...
                    System.out.println("Giá trung bình của các sản phẩm trước khi xóa mảng là:" + giaTB);

                    break;
                case 5:
                    Bai3[] themSanPham = new Bai3[n + 1];
                    ...
                    if(viTriThem == sanPham.length){
                        ...
                        int gia = sc.nextInt();
                        sc.nextLine();
                        themSanPham[viTriThem] = new Bai3(ten,gia);
                    }
                    for (int i = 0; i < sanPham.length; i++) {
                        if (i == viTriThem) {
                            System.out.print("Nhập tên sản phẩm:");
